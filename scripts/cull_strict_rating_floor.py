...
def main() -> int:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path(__file__).resolve().parents[1] / 'build/staging-strict-2000')
    parser.add_argument("--twic-json", type=Path, default=Path(__file__).resolve().parents[1] / 'build/crosstables/twic.json')
    parser.add_argument("--twic-pre-json", type=Path, default=Path(__file__).resolve().parents[1] / 'build/crosstables/twic-pre.json')
